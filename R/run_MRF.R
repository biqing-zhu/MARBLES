...
#' \item{x_mat}{Trace of the DE status for each cell type in the ICM algorithm. A 2-dimensional array: (num of cell types)*(num of iterations). The first column represents the initialization, and the last column represents the final DE status}.
#' \item{theta_mat}{Trace of the estimated model parameters \\Theta in the ICM algorithm. A 2-dimensional array: 2*(num of iterations). The first column represents the initialization, and the last column represents the final parameters}.
#' \item{phi_mat}{Trace of the estimated model parameters \\Phi in the ICM algorithm. A 2-dimensional array: 2*(num of iterations). The first column represents the initialization, and the last column represents the final parameters}.
#' @export
#' 
